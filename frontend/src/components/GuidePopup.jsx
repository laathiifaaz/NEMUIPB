...
const userGuideSections = [
  {
    ...
    steps: [
      ...
      "Unggah foto atau bukti visual barang jika tersedia.",
      "Kirim laporan dan tunggu verifikasi admin.",
      "Pantau status laporan di menu Verifikasi.",
    ],
  },
  {
    icon: "fa-search-plus",
    ...
    steps: [
      ...
      "Unggah foto barang agar pemilik mudah mengenali.",
      "Kirim laporan agar admin dapat memverifikasi dan menampilkan barang.",
    ],
  },
  {
    icon: "fa-hand-holding",
    title: "Cara Klaim Barang",
    description: "Gunakan klaim jika barang ditemukan di koleksi sesuai dengan barang hilang milikmu.",
    steps: [
      "Pastikan kamu sudah membuat laporan kehilangan terlebih dahulu.",
      "Buka Koleksi Barang dan cari barang berstatus ditemukan.",
      "Buka Detail Barang, lalu pilih laporan kehilangan yang sesuai.",
      "Klik Ajukan Klaim untuk mengirim klaim ke admin.",
      "Jika klaim diterima, admin membuat dokumen serah terima dan barang siap diproses.",
    ],
  },
];
